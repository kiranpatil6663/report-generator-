// Sample Assessment Data - Provided by Assignment
...
// Helper function to find session by ID
 const findSessionById = (sessionId) => {
  return assessmentData.find(session => session.session_id === sessionId);
};

// Helper function to get all sessions by assessment type
const findSessionsByAssessmentType = (assessmentId) => {
  return assessmentData.filter(session => session.assessment_id === assessmentId);
};

export {assessmentData,findSessionById ,findSessionsByAssessmentType}